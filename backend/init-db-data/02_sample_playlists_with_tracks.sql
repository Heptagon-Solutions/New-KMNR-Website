...
-- This version uses variables to handle auto-generated IDs properly

USE `kwip`;

-- First, add the playlists and let MySQL auto-generate the IDs
INSERT INTO `playlist` (`date_played`, `posting_dj_id`, `radio_show_id`, `name`, `description`) VALUES
...
-- Get the IDs of the playlists we just inserted
-- We know they will be the last 6 playlists added

-- Add tracks for Friday Indie Mix (will be ID 5)
...
-- Add tracks for Electronic Vibes (will be ID 6)
INSERT INTO `playlist_track` VALUES
...
-- Add tracks for Classic Rock Hour (will be ID 7)
INSERT INTO `playlist_track` VALUES
...
-- Add tracks for Jazz & Blues Evening (will be ID 8)
INSERT INTO `playlist_track` VALUES
...
-- Add tracks for Metal Mayhem (will be ID 9)
INSERT INTO `playlist_track` VALUES
...
-- Add tracks for Morning Pop Mix (will be ID 10)
INSERT INTO `playlist_track` VALUES
